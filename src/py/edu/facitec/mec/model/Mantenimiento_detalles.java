 ...
 * @author user
 */
public class Mantenimiento_detalles {
    ...
    public Mantenimiento_detalles(int codigo, int mantenimiento_codigo, int servicio_codigo, Double cantidad, Double precio, Double subtotal) {
        this.codigo = codigo;
